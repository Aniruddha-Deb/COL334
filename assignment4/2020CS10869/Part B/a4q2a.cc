...
void run_sim(double delay_ms) {
  ...
  csma.SetChannelAttribute ("Delay", TimeValue (MilliSeconds (delay_ms)));
...
//  listRH.Add (staticRh, 5);
  ...
  std::ofstream of("a4q2_"+std::to_string((int)delay_ms)+"ms.log");
...
int main (int argc, char **argv)
{
    ...
    double delays[] = {100, 1000, 20000, 80000};
